...
function NpcBotCommands.OnCommandHandler(event, player, command, chatHandler)
    ...
    local scriptName = target and target:GetScriptName() or nil
...
local TankItems = {
    ...
    [60] = {17734, 13177, 14552, 15413, 11703, 11927, 14549, 17014, 13072, 12544, 22680, 17904, 17909, 12551, 11684, 1168},    
...
local MailDamage = {
	...
	["80_epic"] = {51866, 50633, 54566, 50656, 50995, 50645, 50607, 54580, 50675, 51900, 50678, 54588, 54590, 51933},
}
